    ...
    <footer className="bg-[#333333] text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Holistic Yog Foundation</h3>
            <p className="text-sm text-gray-300 mb-2">202, Lotus sector 20</p>
            <p className="text-sm text-gray-300 mb-4">Matunga, Mumbai</p>
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm">holisticyogfoundation.gmail.com</span>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-2">Monday to Friday:</p>
            <p className="text-sm text-gray-300 mb-4">8 AM - 7 PM</p>
            <p className="text-sm text-gray-300 mb-4">Sunday: Closed</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/all-courses" className="text-gray-300 hover:text-white transition-colors">Courses</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/workshops/power" className="text-gray-300 hover:text-white transition-colors">Power Yoga</Link></li>
